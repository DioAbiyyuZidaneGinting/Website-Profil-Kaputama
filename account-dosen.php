...
<body>
    ...
    <div class="containerkrs">
        ...
        <div class="password" id="perhatian">
            <p>Ingin mengganti password? <a href="change-password-dosen.php">Klik Disini</a></p>
        </div>
        ...
        <div class="table-container">
            <table class="table">
                <tbody>
                    <tr class="ganjil">
                        <td class="kiri"> NIDN </td>
                        <td class="tengah"> : </td>
                        <td class="kanan"><?php echo htmlspecialchars($_SESSION['nidn']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="ganjil">
    <td class="kiri"> <button class="editdata"><a href="edit-dosen.php?nidn=<?php echo $_SESSION['nidn']; ?>">Edit Data</a></button> </td>
    <td class="tengah">  </td>
    <td class="kanan"></td>
</tr>
