    ...
    if(!$title) {
        ...
        if(in_array($extension, $allowed_files)){
            ...
            if($thumbnail['size'] < 10000000){
                ...
                $_SESSION['edit-post'] = "Ukuran file terlalu besar. Harus kurang dari 2MB.";
            }
        } else {
            $_SESSION['edit-post'] = "File harus png, jpg, or jpeg";
...
if(!mysqli_errno($connection)){
    ...
    unset($_SESSION['add-post-success']); // Hapus session lain
    }
}
