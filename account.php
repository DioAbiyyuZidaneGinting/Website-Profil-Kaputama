...
<body>
    ...
    <div class="containerkrs">
        ...
        <div class="password" id="perhatian">
            <p>Ingin mengganti password? <a href="change-password.php">Klik Disini</a></p>
        </div>
        ...
        <div class="table-container">
            <table class="table">
                <tbody>
                    <tr class="ganjil">
                        <td class="kiri"> NPM </td>
                        <td class="tengah"> : </td>
                        <td class="kanan"><?php echo htmlspecialchars($_SESSION['npm']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="ganjil">
                        <td class="kiri"> NIDN PA </td>
                        <td class="tengah"> : </td>
                        <td class="kanan"><?php echo htmlspecialchars($_SESSION['nidn_pa']); ?></td>
                    </tr>
                    <tr>
                        <td class="kiri"> Nama PA </td>
                        <td class="tengah"> : </td>
                        <td class="kanan"><?php echo htmlspecialchars($_SESSION['nama_pa']); ?></td>
                    </tr>
                    <tr class="ganjil">
                        <td class="kiri"> No HP PA </td>
                        <td class="tengah"> : </td>
                        <td class="kanan"><?php echo htmlspecialchars($_SESSION['no_hp_pa']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr >
                        <td class="kiri"> Program Studi </td>
                        <td class="tengah"> : </td>
                        <td class="kanan"><?php echo htmlspecialchars($_SESSION['program_studi_nama']); ?></td>
                    </tr>
                    <tr class="ganjil">
    <td class="kiri"> <button class="editdata"><a href="edit-mahasiswa.php?npm=<?php echo $_SESSION['npm']; ?>">Edit Data</a></button> </td>
    <td class="tengah">  </td>
    <td class="kanan"></td>
</tr>
                </tbody>
