...
<body>
  ...
  <div class="map-container">
    ...
    <aside id="sidebar">
      <div class="profile-section">
        ...
        if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
          if (isset($_SESSION['username'])) {
            ...
            $stmt = $pdo->prepare('SELECT profile_dosen, username, role, nidn FROM dosen WHERE username = ?');
            ...
            if ($user) {
              ...
              echo '<img src="' . htmlspecialchars($user['profile_dosen']) . '" alt="Foto Profil" class="profile-picture">';
              echo '<div>';
              echo '<span class="username">' . htmlspecialchars($user['username']) . '</span><br>';
              echo '<span class="nidn">NIDN: ' . htmlspecialchars($user['nidn']) . '</span>';
              echo '</div>';
              echo '</div>';
            }
          } else {
      ...
      <ul>
        <li><a href="dosen.php"><i class='bx bx-home'></i>Dashboard</a></li>

        <li><a href="account-dosen.php"><i class='bx bx-user-plus'></i>Account</a></li>
        <li><a href="jadwal-dosen.php"><i class='bx bx-list-ul'></i>Jadwal Ngajar</a></li>
        <li><a href="inputnilai.php"><i class='bx bx-edit'></i>Input Nilai</a></li>
        <li><a href="absensi.php"><i class='bx bx-check-circle'></i>Absensi</a></li>
