...
<body>
  ...
  <section class="Project">
    ...
    <h2>Visi</h2>
    <p>
    “Menjadi program studi manajemen informatika yang unggul profesional, berkarakter, dan berjiwa entrepreneur dalam bidang database development dan multimedia di Sumatera Utara (tahun 2027), serta Indonesia (tahun 2037).” </p>
  ...
  <section class="Project2">
    ...
    <p>1. Menyelenggarakan pendidikan yang berkualitas dalam bidang manajemen informatika serta penerapannya dalam sistem informasi.</p>

    <p>2. Menyelenggarakan penelitian yang berkualitas dibidang manajemen informatika yang mendukung keahlian technopreneur.
    ...
    <p>4. Membina kerja sama dengan pemerintah daerah, industri dan masyarakat dalam penerapan penelitian dan pengabdian masyarakat dalam bidang manajemen informatika.</p>
  ...
  <section class="Project3">
    ...
    <p>1. Menghasilkan lulusan yang berkompeten dalam bidang manajemen informatika terutama database developmen dan multimedia serta penerapannya dalam dunia usaha.</p>
  ...
  <section class="Project4">
    ...
    <p>1. Lulusan menguasai konsep umum sistem informasi, manajemen data/informasi, dan pengembangan sistem informasi untuk memberi solusi berbasis computing dalam lingkungan sistem informasi. IS2020</p>

    <p>2. Lulusan memiliki kemampuan menerapkan sistem aplikasi dengan menggunakan metode dan teknik yang sesuai dengan proses bisnis lingkungan sistem informasi secara umum (IS2020)</p>

    <p>3. Lulusan Memiliki sikap toleran dan bertanggung jawab dalam tim multidisiplin (KKNI 09, CS 2013)</p>

    <p>4. Lulusan mampu mengambil keputusan yang tepat berdasarkan analisis data dan informasi (KKNI 12)</p>
    <p>5. Lulusan Mampu Berkomunikasi secara efektif dalam berbagai konteks profesional
