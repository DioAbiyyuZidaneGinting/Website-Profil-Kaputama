...
// Mengambil total dosen
$queryDosen = "SELECT COUNT(*) AS total_dosen FROM dosen";
$resultDosen = $connection->query($queryDosen);
$rowDosen = $resultDosen->fetch_assoc();
$totalDosen = $rowDosen['total_dosen'];
...
$totalMahasiswa = $rowMahasiswa['total_mahasiswa'];
...
$resultProdi = $connection->query($queryProdi);
$rowProdi = $resultProdi->fetch_assoc();
$totalProdi = $rowProdi['total_prodi'];

// Mengambil total mahasiswa
$queryRuangan = "SELECT COUNT(*) AS total_ruangan FROM ruangan";
$resultRuangan = $connection->query($queryRuangan);
$rowRuangan = $resultRuangan->fetch_assoc();
$totalRuangan = $rowRuangan['total_ruangan'];

$totalUsers = $totalDosen + $totalMahasiswa + $totalAdmin;
?>
    ...
    <div class="containerkrs">
        ...
        <div class="telegram">
            ...
            <div class="map-content">
                ...
                <div class="perhatian">
                    <p>Hai <span class="nama"><?php echo htmlspecialchars($_SESSION['username']); ?></span>, NIA Anda adalah <?php echo htmlspecialchars($_SESSION['nia']); ?>. Selamat datang di halaman ADMIN SIAK Kaputama. Silahkan klik menu pilihan .</p>
                </div>
                ...
                <div class="telegram">
                    ...
                    <div class="telegram1">
                        <div class="icon-tele">
                        </p><?php echo $totalDosen; ?>
                        </div>
                        <h3>Total Dosen  </h3>
                        <p>Total Dosen yang terdaftar saat ini:</p>

                    </div>

                    <div class="telegram1">
                        <div class="icon-tele">
                        <?php echo $totalMahasiswa; ?></p>
                        </div>
                        <h3>Total Mahasiswa</h3>
                        <p>Total Mahasiswa yang terdaftar saat ini:</p> 
                    </div>

                    <div class="telegram1">
                        <div class="icon-tele">
                        <?php echo $totalAdmin; ?></p>
                        </div>
                        <h3>Total Admin</h3>
                        <p>Total Admin yang terdaftar saat ini:</p> 
                    </div>
                    ...
                    <div class="telegram1">
                        ...
                        <h3>Total</h3>
                        <p>Total User yang terdaftar saat ini:</p> 
                    </div>
                    ...
                    <div class="telegram1">
                        ...
                        <h3>Total</h3>
                        <p>Total Program Studi saat ini:</p> 
                    </div>
